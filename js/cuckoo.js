function generateBubbles(e) {
        ...
        return function(t) {
            ...
            if (a !== t) {
                var s = t.x - a.x,
                    ...
                    n = Math.sqrt(s * s + o * o),
                    i = t.radius + a.radius;
                n !== i && (n = (n - i) / n * e, t.x -= s *= n, t.y -= o *= n, a.x += s, a.y += o)
            }
        }
    }
        ...
        return function(a) {
            ...
            t.visit(function(t, s, c, m, p) {
                if (t.point && t.point !== a) {
                    ...
                    v < k && (v = (v - k) / v * e, a.x -= l *= v, a.y -= f *= v, t.point.x += l, t.point.y += f)
                }
    ...
    var p = u.length,
        ...
        v = d3.range(p).map(function(e) {
            ...
            return (!l[a] || t > l[a].radius) && (l[a] = s), s
        });
...
function updateActivity(e) {
    ...
    for (var s = 0; s < t.length; s++) {
        var o = $('<div class="activity__item"><div class="activity__info">' + t[s].message + '<span class="activity__time">' + t[s].time_since + "</span></div></div>"),
            n = t[s].user;
        o.prepend(createAvatarElement(n)), a.append(o)
    }
}

function updateRoadmap(e) {
    var t = $(".js-roadmaps");
    t.empty(), e.sessions.forEach(function(e) {
        ...
        e.current && a.addClass("isCurrent"), e.finished && a.addClass("isFinished"), t.append(a)
    })
}
...
function updateSettings(e) {
    function t(e, t) {
        ...
        s.children().remove();
        for (var o = 0; o < e.length; o++) a(e[o], s)
    }
...
var clipboard = function() {
    ...
    return 0 !== e.length && e.attr("size", e.val().length - 2), new Clipboard(".js-copy-clipboard")
}();
Piecon.setOptions({
    color: "#6B6DE2",
    background: "#fff",
    ...
    e.preventDefault(), $.ajax({
        ...
        success: function(e) {
            $("#js-feedback-form-response").html("Your feedback was sent. <br>Thank you! 👋"), $(".js-feedback-text").val("")
        }
    })
...
var Notifications = function() {
        ...
        return {
            ...
            cuckooNotify: function(e) {
                e.flags._isBreakTime ? (Sounds.soundCuckooFocusEnd.play(), s.show()) : (Sounds.soundCuckooBreakEnd.play(), a.show())
            },
            inAppNotification: function(t, a) {
                t && $(".js-notification").html('<div class="notification">' + t + "</div>"), void 0 !== e && clearTimeout(e), e = setTimeout(function() {
